...
import 'package:sevenouti/client/repository/client_profile_repository.dart';
...
class _ClientSettingsPageState extends State<ClientSettingsPage> {
  final _repository = ClientProfileRepository(ApiService());
  ...
  Future<void> _save() async {
    ...
    if (name.isEmpty || phone.isEmpty) {
      AppSnackBar.show(
        context,
        message: l10n.clientSettingsRequiredFields,
    ...
    try {
      ...
      AppSnackBar.show(
        context,
        message: l10n.clientSettingsSaved,
      ...
      AppSnackBar.show(
        context,
        message: l10n.clientSettingsSaveError(e.toString()),
        type: SnackBarType.error,
      );
    } finally {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_loading) {
      return Scaffold(
        appBar: AppBar(title: Text(l10n.clientSettingsTitle)),
        body: LoadingView(message: l10n.clientSettingsLoading),
      );
    }
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.clientSettingsTitle),
        actions: [
          TextButton(
            ...
            child: _saving
                ...
                : Text(l10n.clientSettingsSaveButton),
          ),
        ],
      ),
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              labelText: l10n.clientSettingsNameLabel,
            ),
          ),
          const SizedBox(height: AppSpacing.sm),
          TextField(
          ...
          TextField(
            ...
            readOnly: true,
            decoration: InputDecoration(
              labelText: l10n.clientSettingsEmailLabel,
            ),
          ),
          const SizedBox(height: AppSpacing.sm),
          TextField(
